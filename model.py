    ...
    def train(self, data):
      ...
      for idx in range(N):
        ...
        for b in range(self.batch_size):
            ...
            # print("target_data.size: ", len(target_data))
            # print("target_data[m]: ", target_data[m])
            # target_data_m = target_data[m]
            # x_b_zero = x[b][0]
            # print("type of target_data_m: ", type(target_data_m))
            # print("type of x_b_zero: ", type(x_b_zero))
            x[b][0] = target_data[m][0]
